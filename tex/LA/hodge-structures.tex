...
\begin{example}{hodge-structure}
    Let $M$ be a \tref{DG:kahler-manifold}{Kahler manifold} of dimension $2n$. It follows from the Hodge theorem that its \tref{DG:de-rham-cohomology}{de Rham cohomology} carries a Hodge structure
