...
\begin{topic}{seifert-van-kampen-theorem}{Seifert--van Kampen theorem}
    The \textbf{Seifert--van Kampen theorem} states that for every \tref{TO:path-connected}{path-connected} \tref{TO:topological-space}{topological space} $X$ and path-connected subsets $U, V \subset X$ such that the intersection $U \cap V$ is path-connected and the \tref{TO:interior}{interiors} $\overset{\circ}{U}$ and $\overset{\circ}{V}$ cover $X$, the diagram of \tref{fundamental-group}{fundamental groups}
