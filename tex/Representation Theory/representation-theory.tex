...
\begin{example}{tannakian-category}
    Let $\mathcal{C}$ be the category of \tref{LA:hodge-structure}{real Hodge structures} $(H_\RR, \{ H^{p, q} \})$, and let $\omega : \mathcal{C} \to \textbf{Vect}_\RR$ be the forgetful functor that sends $(H, \{ H^{p, q} \})$ to $H$.
