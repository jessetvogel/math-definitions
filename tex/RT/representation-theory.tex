...
\begin{topic}{schur-lemma}{Schur's lemma}
    ...
    \begin{enumerate}[(i)]
        ...
        \item If $\rho : G \to \textup{GL}(V)$ is an irreducible representation over an \tref{CA:algebraically-closed-field}{algebraically closed field $k$}, and $A : V \to V$ is a linear map such that $A \rho(g) = \rho(g) A$ for all $g \in G$, then $A$ is a scalar multiple of the identity map.
    \end{enumerate}
\end{topic}
