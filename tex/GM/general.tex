...
\begin{topic}{zorns-lemma}{Zorn's lemma}
    Let $P$ be a \tref{OT:partially-ordered-set}{partially ordered set}, such that every chain in $P$
...
\begin{topic}{equivalence-relation}{equivalence relation}
    Let $X$ be a set. An \textbf{equivalence relation} on $X$ is a \tref{OT:binary-relation}{binary relation} $\sim$ on $X$ such that
    \begin{itemize}
