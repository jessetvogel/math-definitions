...
\begin{topic}{algebraic-multiplicity}{algebraic multiplicity}
...
\begin{topic}{geometric-multiplicity}{geometric multiplicity}
    Let $A$ be an $n \times n$ matrix. The \textbf{geometric multiplicity} of an eigenvalue $\lambda$ of $A$ is the \tref{dimension}{dimension} of the corresponding \textit{eigenspace}
