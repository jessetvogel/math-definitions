...
\begin{topic}{cech-nerve}{Čech nerve}
    Let $\mathcal{C}$ be a \tref{category}{category} with \tref{pullback}{pullbacks}. The \textbf{Čech nerve} of a morphism $U \to X$ is the \tref{simplicial-object}{simplicial object} $C(U \to X)$ in $\mathcal{C}$ given by
