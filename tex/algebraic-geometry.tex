...
\begin{topic}{fppf-covering}{fppf covering}
    An \textbf{fppf covering} of a \tref{scheme}{scheme} $X$ is a family of morphisms $\left\{ f_i : X_i \to X \right\}_{i \in I}$ that are all \tref{flat-morphism}{flat}, locally of finite presentation, and jointly surjective, i.e. $X = \bigcup_{i \in I} f_i(X_i)$.
