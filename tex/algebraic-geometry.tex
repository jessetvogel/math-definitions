...
\begin{topic}{open-immersion}{open-immersion}
    An \textbf{open immersion} is a morphism $f : U \to X$ of \tref{scheme}{schemes} which induces an isomorphism of $U$ with an open subscheme of $X$.
\end{topic}
...
\begin{topic}{projective-morphism}{projective morphism}
...
\begin{topic}{quasi-projective}{quasi-projective}
    A morphism $f : X \to Y$ of \tref{scheme}{schemes} is \textbf{quasi-projective} if it factors as
    \[ X \xrightarrow{j} X' \xrightarrow{g} Y , \]
    with $j$ an \tref{open-immersion}{open immersion} and $g$ a \tref{projective-morphism}{projective morphism}.
\end{topic}
