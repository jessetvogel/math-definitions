...
\begin{example}{mayer-vietoris-sequence}
    ...
    where $\Delta : A \oplus A \to A$ is given by $(a, b) \mapsto a + b$. Now we can read off that $H^0(X; A) = \ker(\Delta) \simeq A$ and $H^1(X; A) \simeq A \oplus A$ and $H^n(X; A) = 0$ for $n \ge 2$.
\end{example}
