...
%     Let $p : E \to B$ be a \tref{fiber-bundle}{fiber bundle} with fiber $F$, and let $G$ be a group acting continuously and \tref{GT:faithful-action}{faithfully} on $F$.
    
    
%     then $G$ is called the \textbf{structure group} of the bundle. In physics, this is called the \textit{gauge group} of the bundle.
% \end{topic}
