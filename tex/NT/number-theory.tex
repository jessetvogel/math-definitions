...
\begin{example}{abel-ruffini-theorem}
    \begin{proof}
        Let $f \in k[x]$ be a polynomial over a field $k$, and let $\ell/k$ be a \tref{CA:splitting-field}{splitting field} of $f$. Then in particular $\ell/k$ is a \tref{CA:galois-extension}{Galois extension}. Now if $f$ is solvable by radicals, then we can write
