...
\begin{example}{t-structure}
    ...
    \[ \begin{aligned}
        \textbf{D}(\mathcal{A})_{\ge 0} &= \{ A_\bdot \in \textbf{D}(\mathcal{A}) \;|\; H_i(A_\bdot) = 0 \textup{ for all } i < 0 \} , \\
        \textbf{D}(\mathcal{A})_{\le 0} &= \{ A_\bdot \in \textbf{D}(\mathcal{A}) \;|\; H_i(A_\bdot) = 0 \textup{ for all } i > 0 \} .
    \end{aligned} \]
    ...
    Furthermore, the heart $\textbf{D}(\mathcal{A})^\heartsuit = \{ A_\bdot \in \textbf{D}(\mathcal{A}) \;|\; H_i(A_\bdot) = 0 \textup{ for all } i \ne 0 \}$ is equivalent to $\mathcal{A}$ via the functor $H_0$.
\end{example}
