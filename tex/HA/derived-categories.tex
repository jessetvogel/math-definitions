...
\begin{topic}{perfect-complex}{perfect complex}
    Let $R$ be a \tref{AA:ring}{commutative ring} and let $\textbf{D}(\textbf{Mod}_R)$ be the \tref{derived-category}{derived category} of $R$-modules. A complex in $\textbf{D}(\textbf{Mod}_R)$ is \textbf{perfect} if it is \tref{quasi-isomorphism}{quasi-isomorphic} to a bounded complex of \tref{AA:finitely-generated-module}{finitely generated} \tref{AA:projective-module}{projective} $R$-modules.
