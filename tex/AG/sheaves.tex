...
\begin{topic}{constructible-sheaf}{constructible sheaf}
    A \tref{sheaf}{sheaf} $\mathcal{F}$ over a \tref{TO:topological-space}{topological space} $X$ is \textbf{constructible} if $X$ can be written as a finite union of locally closed sets $X_i$ such that the restriction of $\mathcal{F}$ to $X_i$ is \tref{constant-sheaf}{locally constant} for all $i$.
\end{topic}
