...
\begin{example}{group-scheme}
    \begin{itemize}
        \item For any \tref{GT:group}{group} $G$, the scheme $G_S = \bigsqcup_{g \in G} S$, with multiplication, inversion and the unit given by $G$, is a group scheme, called the \textit{constant group scheme}.
