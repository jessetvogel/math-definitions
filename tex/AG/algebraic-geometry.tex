...
\begin{topic}{larsen-lunts-theorem}{Larsen--Lunts theorem}
    Let $\textup{SB}$ be the set of \tref{stably-birational}{stably birational} equivalence classes of \tref{non-singular-variety}{smooth} \tref{proper-morphism}{proper} \tref{variety}{varieties} over $\CC$. The \textbf{Larsen--Lunts theorem} states that there exists a unique ring morphism
