...
\begin{topic}{koszul-algebra}{Koszul algebra}
    A \textbf{Koszul algebra} $A$ over a \tref{CA:field}{field} $k$ is a \tref{CA:graded-ring}{graded} \tref{CA:algebra}{$k$-algebra}, such that the ground field $k$ has a linear minimal graded free resolution, that is, there exists an exact sequence
