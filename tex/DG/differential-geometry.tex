...
\begin{topic}{higgs-bundle}{Higgs bundle}
    Let $M$ be a \tref{complex-manifold}{complex manifold}. A \textbf{Higgs bundle} on $M$ is a holomorphic \tref{vector-bundle}{vector bundle} $E$ on $M$ together with a section $\phi \in \Omega^1(M; \text{End}(E))$, called the \textbf{Higgs field}, satisfying $\phi \wedge \phi = 0$.
\end{topic}
...
%     \[ \nabla = d + A \]
%     with $A \in \Omega^1(\mathfrak{g} \times M) \simeq \Omega^1(M)$.
