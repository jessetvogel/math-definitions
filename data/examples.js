const examples = [
  ...
  "PT:bernoulli-distribution",
  "PT:binomial-distribution",
  "PT:negative-binomial-distribution",
  "PT:geometric-distribution",
  "PT:poisson-distribution",
  "PT:exponential-distribution",
  "PT:gamma-distribution",
  "PT:beta-distribution",
  "PT:normal-distribution",
  "PT:uniform-distribution",
  "PT:chi-squared-distribution",
  "PT:student-t-distribution",
  "PT:correlation",
  "PT:moment",
  "PT:moment-generating-function",
  "PT:statistic",
  "PT:sufficient-statistic",
  "PT:complete-statistic",
  "PT:method-of-moments",
